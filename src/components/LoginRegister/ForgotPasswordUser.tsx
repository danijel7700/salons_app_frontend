...
export default function ForgotPasswordUserCard() {
  ...
  const sendEmail = () => {
    axios
      .post(`http://localhost:3000/users/send-reset-email/${email}`, {}, {})
      .then((res) => {
  ...
  const recoverPassword = () => {
    ...
    axios
      .patch(`http://localhost:3000/users/reset-password`, data, {})
      .then((res) => {
        console.log(res.data);
        navigate("/login");
      })
